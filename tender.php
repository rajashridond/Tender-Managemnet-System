...
Tender-<?=$n?></br>		
			...
			<a class="bg-danger" style="font-weight:bold">Item Name  - <?=$sector_name?></a></br>
			
			<a class="bg-danger" style="font-weight:bold">City - <?=$city?></a></br>
			<a class="bg-danger" style="font-weight:bold">Budget Price -  <?=$INR?>/-</a></br>
			</div>
					<div class="col-lg-3">			
						<img src="admin/<?=$fileone?>" style="height:100px" alt=""/>
					</div>
			<div class="col-lg-3">
			
 <?=ucwords($discription)?><a href="admin/<?=$filetwo?>" class="btn btn-danger">  | Download File</a>		
			</div>
				<div class="col-lg-2" style="color:blue">
 Due Date-<?=$due_date?></br>		
 Quantity-<?=$qty?>		
			</div>
			<a href="bidding.php?id=<?=$id?>&qty1=<?=$qty?>&inr=<?=$INR?>""><div class="col-lg-1"><button class="btn btn-danger ">B I D</button></div></a>
